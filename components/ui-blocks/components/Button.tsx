...
export type ButtonProps<T extends RenderAsType = 'button'> = Omit<
    Omit<VariantProps<typeof StyledButton>, 'icon'> & Omit<GetRenderAsProps<T>, 'size' | 'ref'>,
...
function ButtonComponent<T extends RenderAsType = 'button'>(
    { children, as, icon, iconLeft, iconRight, size = 'medium', ...props }: ButtonProps<T>,
    ...
    const iconSize = iconSizes[size as keyof typeof iconSizes] || 18
